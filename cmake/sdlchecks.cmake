...
macro(CheckOpenVR)
  if(SDL_OPENVR)
    set(EGL_PKG_CONFIG_SPEC "egl")
    find_package(OpenGL MODULE)
    if(PKG_CONFIG_FOUND)
      pkg_check_modules(PC_EGL IMPORTED_TARGET ${EGL_PKG_CONFIG_SPEC})
    endif()
    if(OpenGL_EGL_FOUND OR PC_EGL_FOUND)
      ...
      FindLibraryAndSONAME(EGL LIBDIRS ${PC_EGL_LIBRARY_DIRS})
      if(SDL_OPENVR_SHARED AND EGL_LIB_SONAME AND HAVE_SDL_LOADSO)
        set(SDL_VIDEO_DRIVER_OPENVR_DYNAMIC_EGL "\"${EGL_LIB_SONAME}\"")
        set(HAVE_OPENVR_SHARED TRUE)
      else()
        sdl_link_dependency(egl LIBS PkgConfig::PC_LIBDECOR PKG_CONFIG_PREFIX PC_EGL PKG_CONFIG_SPECS ${EGL_PKG_CONFIG_SPEC})
      endif()
    endif()
  endif()
endmacro()
